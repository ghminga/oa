    ...
    <form class="form-inline">
        <div class="panel panel-default">
            ...
            <div class="table-responsive">
               ...
               <ul class="pagination">
    		<li class="page-item"><a class="page-link" href="myBaoxiaoBill?pageNum=1">首页</a></li>
    		<li class="page-item"><a class="page-link" href="myBaoxiaoBill?pageNum=${pageInfo.prePage}">上一页</a></li>
    		<li class="page-item"><a class="page-link" href="myBaoxiaoBill?pageNum=${pageInfo.nextPage}">下一页</a></li>
    		<li class="page-item"><a class="page-link" href="myBaoxiaoBill?pageNum=${pageInfo.pages}">尾页</a></li>
    		</ul>
            </div>
        </div>
    </form>
